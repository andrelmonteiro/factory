...
import static com.jhipster.demo.store.domain.ShoppingCartAsserts.*;
...
class ShoppingCartResourceIT {
    ...
    void partialUpdateShoppingCartWithPatch() throws Exception {
        ...
        partialUpdatedShoppingCart.totalPrice(UPDATED_TOTAL_PRICE).paymentMethod(UPDATED_PAYMENT_METHOD);
